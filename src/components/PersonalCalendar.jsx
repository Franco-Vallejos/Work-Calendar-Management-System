...
function PersonalCalendar({jsonList, dni, calendarList, personalList}){
    ...
    return(
        <div className="container-pc">
            ...
            <Calendar jsonList = {jsonList} dni = {dni} personalList = {personalList}
                    esFormat = {esFormat} month = {month} year = {year} onlyMyCalendar = {onlyMyCalendar}/>
        </div>
    );
}
